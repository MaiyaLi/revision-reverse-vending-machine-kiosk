...
export default function App() {
  ...
  const processNextItemSequential = async (idx: number, fullList: DepositedItem[], currentSessionRefId: string | null) => {
    ...
    // Step 2: Inductive sensor
    setVerificationStage('INDUCTIVE');
    await new Promise(r => setTimeout(r, 1000));

    // Step 3: Weight sensor
                    ...
                    {backendCameraActive ? (
                     ...
                     <div className="flex-1 flex flex-col items-center justify-center text-center p-6 min-h-[280px]">
                        <div className="w-28 h-28 rounded-2xl bg-slate-800 flex items-center justify-center border border-slate-700 relative mb-4">
                          ...
                          {verificationStage === 'INDUCTIVE' && <Wifi className="w-12 h-12 text-sky-400 animate-bounce" />}
                          {verificationStage === 'WEIGHT' && <Cpu className="w-12 h-12 text-emerald-400 animate-spin" />}
                          {verificationStage === 'TOF' && <Sliders className="w-12 h-12 text-indigo-400 animate-pulse" />}
                         ...
                         <input
                          ...
                          onChange={(e) => {
                            ...
                            if (isNaN(val) || val < 0) {
                              ...
                              setCashOutAmount(Math.floor(val));
                            }
                          }}
