...
export const translations: Record<Language, TranslationSet> = {
  en: {
    ...
    depositPlanIntro: "Place your recyclable containers in the camera view, then start the scan.",
    ...
    withdrawQRPhTitle: "QRPh E-Wallet Payout",
    withdrawCashTitle: "Coin Dispenser",
    selectBank: "Select GCash or Maya",
    generatingQRPh: "Generating QRPh code...",
    scanToReceivePayout: "Scan QR below with GCash or Maya to receive instant credit.",
  ...
  fil: {
    ...
    depositPlanIntro: "Ilagay ang mga mairi-recycle na lalagyan sa harap ng kamera, pagkatapos ay simulan ang scan.",
    ...
    withdrawQRPhTitle: "QRPh E-Wallet Paglipat",
    withdrawCashTitle: "RVM Coin Dispenser",
    selectBank: "Pumili ng GCash o Maya",
    generatingQRPh: "Hinahanda ang QRPh Code...",
    scanToReceivePayout: "I-scan ang QR gamit ang GCash o Maya para ipadala ang pera.",
    referenceNumber: "Reference ID",
